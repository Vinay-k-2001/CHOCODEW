...
<h3><input type="checkbox" name="f1" value=120><b>    Aloo tikki burger</b> <span class="w3-right w3-tag w3-dark-grey w3-round">120/-</span></h1>
<hr>
<h3><input type="checkbox" name="f2" value=150><b>    Chicken burger</b> <span class="w3-right w3-tag w3-dark-grey w3-round">150/-</span></h1>
<hr>
<h3><input type="checkbox" name="f3" value=140><b>     Egg burger </b> <span class="w3-right w3-tag w3-dark-grey w3-round">140/-</span></h1>
<hr>
<h3><input type="checkbox" name="f4" value=140><b>     Paneer burger</b> <span class="w3-right w3-tag w3-dark-grey w3-round">140/-</span></h1>
<hr>
<hr>
<h3><input type="checkbox" name="f5" value=120><b>     Veg burger</b> <span class="w3-right w3-tag w3-dark-grey w3-round">120/-</span></h1>
<hr>
...
if (isset($_POST['f1'])) {
    $price1 = $price1 + (int) $_POST['f1'];
}
    if (isset($_POST['f2'])) {
        $price1 = $price1 + (int) $_POST['f2'];
    
}
if (isset($_POST['f3'])) {
    $price1= $price1 + (int) $_POST['f3'];
}
if (isset($_POST['f4'])) {
    $price1 = $price1 + (int) $_POST['f4'];
}

if (isset($_POST['f5'])) {
    $price1 = $price1 + (int) $_POST['f5'];
}

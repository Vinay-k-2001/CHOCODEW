...
<h3><input type="checkbox" name="d1" value=150><b>    Belgium dark chocolate milkshake</b> <span class="w3-right w3-tag w3-dark-grey w3-round">150/-</span></h1>
<hr>
<h3><input type="checkbox" name="d2" value=150><b>    Butterscotch milkshake</b> <span class="w3-right w3-tag w3-dark-grey w3-round">150/-</span></h1>
<hr>
<h3><input type="checkbox" name="d3" value=150><b>     Chocolate milkshake</b> <span class="w3-right w3-tag w3-dark-grey w3-round">150/-</span></h1>
<hr>
<h3><input type="checkbox" name="d4" value=150><b>     Strawberry milkshake</b> <span class="w3-right w3-tag w3-dark-grey w3-round">150/-</span></h1>
<hr>
<hr>
<h3><input type="checkbox" name="d5" value=150><b>     Vanilla milkshake</b> <span class="w3-right w3-tag w3-dark-grey w3-round">150/-</span></h1>
<hr>
...
if (isset($_POST['d1'])) {
    $price1 = $price1 + (int) $_POST['d1'];
}
    if (isset($_POST['d2'])) {
        $price1 = $price1 + (int) $_POST['d2'];
    
}
if (isset($_POST['d3'])) {
    $price1 = $price1 + (int) $_POST['d3'];
}
if (isset($_POST['d4'])) {
    $price1 = $price1 + (int) $_POST['d4'];
}

if (isset($_POST['d5'])) {
    $price1 = $price1 + (int) $_POST['d5'];
}

...
<h3><input type="checkbox" name="b1" value=850><b>    Hugs with white ice cream</b> <span class="w3-right w3-tag w3-dark-grey w3-round">850/-</span></h1>
<hr>
<h3><input type="checkbox" name="b2" value=470><b>    Kisses with milk chocolate</b> <span class="w3-right w3-tag w3-dark-grey w3-round">470/-</span></h1>
<hr>
<h3><input type="checkbox" name="b3" value=800><b>     Kisses with milk chocolate and caramel</b> <span class="w3-right w3-tag w3-dark-grey w3-round">800/-</span></h1>
<hr>
<h3><input type="checkbox" name="b4" value=850><b>     Kisses with milk chocolate with almonds</b> <span class="w3-right w3-tag w3-dark-grey w3-round">850/-</span></h1>
<hr>
<hr>
<h3><input type="checkbox" name="b5" value=470><b>     Kisses with almonds</b> <span class="w3-right w3-tag w3-dark-grey w3-round">470/-</span></h1>
<hr>
...
if (isset($_POST['b1'])) {
    $price1 = $price1 + (int) $_POST['b1'];
}
    if (isset($_POST['b2'])) {
        $price1 = $price1 + (int) $_POST['b2'];
    
}
if (isset($_POST['b3'])) {
    $price1 = $price1 + (int) $_POST['b3'];
}
if (isset($_POST['b4'])) {
    $price1 = $price1 + (int) $_POST['b4'];
}
    if (isset($_POST['b5'])) {
        $price1 = $price1 + (int) $_POST['b5'];

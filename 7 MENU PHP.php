...
<div class="w3-row w3-center w3-border w3-border-dark-grey">
    ...
    <a href="9 MENU PHP.phps"><div class="w3-third w3-padding-medium ">Mocktails</div></a>
</div>
...
<h3><input type="checkbox" name="g1" value=200><b>    Brownie break icecream</b> <span class="w3-right w3-tag w3-dark-grey w3-round">200/-</span></h1>
<hr>
<h3><input type="checkbox" name="g2" value=200><b>    Choco lava icecream</b> <span class="w3-right w3-tag w3-dark-grey w3-round">200/-</span></h1>
<hr>
<h3><input type="checkbox" name="g3" value=200><b>     Oreo shot icecream</b> <span class="w3-right w3-tag w3-dark-grey w3-round">200/-</span></h1>
<hr>
<h3><input type="checkbox" name="g4" value=140><b>     Fruit salad with icecream</b> <span class="w3-right w3-tag w3-dark-grey w3-round">140/-</span></h1>
<hr>
...
if (isset($_POST['g1'])) {
    $price1 = $price1 + (int) $_POST['g1'];
}
    if (isset($_POST['g2'])) {
        $price1 = $price1 + (int) $_POST['g2'];
    
}
if (isset($_POST['g3'])) {
    $price1 = $price1 + (int) $_POST['g3'];
}
if (isset($_POST['g4'])) {
    $price1 = $price1 + (int) $_POST['g4'];
}
